...
# This Dockerfile builds a Mercedes-Benz environment.
...
# 5. "prod" - Creates the final production image with the Mercedes-Benz, Nginx, and other dependencies.
...
# Copy essential files for installing Mercedes-Benz and its dependencies
