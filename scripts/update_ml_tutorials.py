...
1. Downloads all README.md files in the label-studio-ml repository https://github.com/Mercedes-Benz/label-studio-ml-backend by path label_studio_ml/examples/{model_name}/README.md
