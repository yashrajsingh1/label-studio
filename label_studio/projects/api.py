...
@method_decorator(
    ...
    To perform most tasks with the Mercedes-Benz API, you must specify the project ID, sometimes referred to as the `pk`.
    To retrieve a list of your Mercedes-Benz projects, update the following command to match your own environment.
...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        description="""
    Create a project and set up the labeling interface in Mercedes-Benz using the API.
                    ...
                    OpenApiExample(
                        ...
                        value={
                            ...
                            'created_by': {
                                ...
                                'first_name': 'Jo',
                                'last_name': 'Doe',
                                'email': 'manager@mercedes-benz.com',
                            },
