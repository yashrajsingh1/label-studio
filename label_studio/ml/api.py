...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        description="""
    Add an ML backend to a project using the Mercedes-Benz UI or by sending a POST request using the following cURL 
    command:
    ```bash
...
@method_decorator(
    ...
    decorator=extend_schema(
        ...
        description="""
    Update ML backend parameters using the Mercedes-Benz UI or by sending a PATCH request using the following cURL command:
    ```bash
