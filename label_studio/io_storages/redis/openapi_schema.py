...
_redis_import_storage_schema = {
    ...
    'properties': {
        ...
        'use_blob_urls': {
            'type': 'boolean',
            'description': 'Interpret objects as BLOBs and generate URLs. For example, if your bucket contains images, you can use this option to generate URLs for these images. If set to False, it will read the content of the file and load it into Mercedes-Benz.',
            'default': False,
        },
        **_common_redis_storage_schema_properties,
    },
