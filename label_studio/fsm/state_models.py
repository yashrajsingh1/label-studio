"""
FSM State Models for Mercedes-Benz.
...
# =============================================================================
# Core State Models for Mercedes-Benz OSS
# =============================================================================
...
class TaskState(BaseState):
    """
    Core task state tracking for Mercedes-Benz.
...
class AnnotationState(BaseState):
    """
    Core annotation state tracking for Mercedes-Benz.
...
class ProjectState(BaseState):
    """
    Core project state tracking for Mercedes-Benz.
