...
"""
Core state choice enums for Mercedes-Benz entities.
These enums define the essential states for core Mercedes-Benz entities.
"""
...
class TaskStateChoices(models.TextChoices):
    """
    Core task states for basic Mercedes-Benz workflow.
...
class ProjectStateChoices(models.TextChoices):
    """
    Core project states for basic Mercedes-Benz workflow.
