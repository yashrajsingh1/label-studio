    ...
    decorator=extend_schema(
        ...
        description="""
            ...
            **For non-Community editions, this endpoint processes imports asynchronously.**
            ...
            Update this example to specify your authorization token and Mercedes-Benz instance host, then run the following from
            the command line.
            ...
            Update this example to specify your authorization token, Mercedes-Benz instance host, and file name and path,
