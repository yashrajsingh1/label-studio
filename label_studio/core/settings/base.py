...
"""
Django Base settings for Mercedes-Benz.
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Mercedes-Benz Data Labeling API',
    'DESCRIPTION': 'Mercedes-Benz API for data annotation and labeling',
    'VERSION': '',
...
# Email backend
FROM_EMAIL = get_env('FROM_EMAIL', 'Mercedes-Benz <hello@labelstud.io>')
...
if ENABLE_CSP := get_bool_env('ENABLE_CSP', True):
    ...
    MIDDLEWARE.append('core.middleware.MercedesBenzCspMiddleware')
...
# Base FSM (Finite State Machine) Configuration for Mercedes-Benz
