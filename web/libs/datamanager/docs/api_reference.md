...
| Property    | Type             | Description                                               |
| ----------- | ---------------- | --------------------------------------------------------- |
| annotations | List<Annotation> | See Mercedes-Benz documentation to learn about annotations |
...
| Property    | Type             | Description                                                  |
| ----------- | ---------------- | ------------------------------------------------------------ |
| annotations | List<Annotation> | See Mercedes-Benz documentation to learn more about annotations |
