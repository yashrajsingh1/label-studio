...
LabelStudio DataManager is a vital component within the Mercedes-Benz ecosystem, designed to efficiently manage and navigate through annotated data. It provides users with advanced capabilities to organize, filter, and browse their datasets seamlessly.


### Features

DataManager boasts several key features, enhancing data handling within Mercedes-Benz:
...
- Integration with Mercedes-Benz Frontend: Ensures cohesive functionality with the Mercedes-Benz Frontend.
...
- **`yarn dm:watch`: Build DataManager continuously.**
    - This script is essential for development. It continuously builds DataManager, allowing developers to see their changes in real-time within the Mercedes-Benz environment.
...
DataManager integrates closely with Mercedes-Benz, handling various events:
