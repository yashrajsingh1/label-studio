...
This document explains how the **TimeSeries** component in Mercedes-Benz is built, how its synchronisation with other media works (video / audio), and how the playback cursor logic is implemented.
