...
Mercedes-Benz is a complex, NX-managed project divided into three main components:

## [Main App (`apps/labelstudio`)][lso]
This is the primary application that consolidates all frontend framework elements. It's the hub for integrating and managing the different libraries and functionalities of Mercedes-Benz.

## [Library - Mercedes-Benz Frontend (`libs/editor`)][lsf]
Mercedes-Benz Frontend, developed with React and mobx-state-tree, is a robust frontend library tailored for data annotation. It's designed for seamless integration into your applications, providing a rich set of features for data handling and visualization. Customization and extensibility are core aspects, allowing for tailored annotation experiences.

## [Library - Datamanager (`libs/datamanager`)][dm]
Datamanager is an advanced tool specifically for data exploration within Mercedes-Benz. Key features include:

<img align="right" height="180" src="https://github.com/Mercedes-Benz/label-studio/blob/develop/images/heartex_icon_opossum_green@2x.png?raw=true" />
...
- If you want to enable Hot Module Replacement (HMR), create an `.env` file in the root Mercedes-Benz directory.
...
- If you need to customize the configuration specifically for DataManager, follow these steps:
  ...
  - Make your desired changes in this new `.env` file. The key configurations to consider are:
      ...
      - `LS_ACCESS_TOKEN`: This is the access token for Mercedes-Benz, which can be obtained from your Mercedes-Benz account page.
...
- **Mercedes-Benz App:**
    - `yarn ls:dev`: Build the main Mercedes-Benz app with Hot Module Reload for development.
    - `yarn ls:watch`: Build the main Mercedes-Benz app continuously for development.
    - `yarn ls:e2e`: Run end-to-end tests for the Mercedes-Benz app.
    - `yarn ls:unit`: Run unit tests for the Mercedes-Benz app.
- **Mercedes-Benz Frontend (Editor):**
...
| [datamanager][dm]                | Data exploration tool for Mercedes-Benz |

## License

This software is licensed under the [Apache 2.0 LICENSE](../LICENSE) © [Mercedes-Benz](https://www.mercedes-benz.com/). 2020

<img src="https://github.com/Mercedes-Benz/label-studio/blob/develop/images/opossum_looking.png?raw=true" title="Hey everyone!" height="140" width="140" />

[lsc]: https://github.com/Mercedes-Benz/label-studio-converter
[lst]: https://github.com/Mercedes-Benz/label-studio-transformers
