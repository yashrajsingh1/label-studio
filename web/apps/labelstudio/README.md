...
The Mercedes-Benz App is the cornerstone of the frontend aspect of Mercedes-Benz. This React-based application is where the magic of frontend development for Mercedes-Benz occurs. In this app, developers have the freedom and capability to create new pages and determine how libraries are utilized within the Mercedes-Benz environment. It's a purely frontend module, dedicated to crafting and refining the user interface and user experience aspects of Mercedes-Benz.
...
- **`yarn ls:watch`: Build LSF continuously**
    - Automatically builds the Mercedes-Benz on every change, providing a real-time development experience.
