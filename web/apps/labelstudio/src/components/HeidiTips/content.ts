...
export const defaultTipsCollection: TipsCollection = {
  projectCreation: [
    {
      title: "Did you know?",
      content: "It’s easier to find the projects when you organize them into workspaces using Mercedes-Benz Enterprise.",
      closable: true,
      link: {
        label: "Learn more",
        url: "https://docs.mercedes-benz.com/guide/manage_projects#Create-workspaces-to-organize-projects",
        params: {
    ...
    },
    {
      ...
      content:
        "Streamline assigning staff to multiple projects by assigning them to workspaces in Mercedes-Benz Enterprise.",
      closable: true,
      link: {
        label: "Learn more",
        url: "https://docs.mercedes-benz.com/guide/manage_projects#Add-or-remove-members-to-a-workspace",
        params: {
          experiment: "project_creation_tip",
    ...
    },
    {
      ...
      link: {
        label: "Learn more",
        url: "https://docs.mercedes-benz.com/guide/dashboard_annotator",
        params: {
          experiment: "project_creation_tip",
    ...
    },
    {
      title: "Did you know?",
      content:
        "You can control access to specific projects and workspaces for internal team members and external annotators using Mercedes-Benz Enterprise.",
      closable: true,
      link: {
        label: "Learn more",
        url: "https://docs.mercedes-benz.com/guide/manage_users#Roles-in-Label-Studio-Enterprise",
        params: {
          experiment: "project_creation_tip",
    ...
    },
    {
      ...
      content:
        "Mercedes-Benz has templates available for supervised LLM fine-tuning, RAG retrieval ranking, RLHF, chatbot evaluation, and more.",
      closable: true,
      link: {
  ...
  organizationPage: [
    {
      ...
      content:
        "Assign roles to your team using Mercedes-Benz Enterprise and control access to sensitive data at the project and workspace levels.",
      closable: true,
      link: {
        label: "Learn more",
        url: "https://docs.mercedes-benz.com/guide/manage_users#Roles-in-Label-Studio-Enterprise",
    ...
    },
    {
      ...
      content: "Enable Single Sign-On for your team using SAML, SCIM2 or LDAP with Mercedes-Benz Enterprise.",
      closable: true,
      link: {
        label: "Learn more",
        url: "https://docs.mercedes-benz.com/guide/auth_setup",
        params: {
          experiment: "organization_page_tip",
    ...
    {
      title: "Did you know?",
      content: "Try Mercedes-Benz Starter Cloud, optimized for small teams and projects.",
      closable: true,
      link: {
        label: "Learn more",
        url: "https://mercedes-benz.com/pricing/",
        params: {
          experiment: "organization_page_tip",
    ...
    },
    {
      ...
      link: {
        label: "Learn more",
        url: "https://docs.mercedes-benz.com/guide/setup_project#Set-up-annotation-settings-for-your-project",
        params: {
          experiment: "organization_page_tip",
    ...
    },
    {
      ...
      content:
        "Have questions or a tip to share with other Mercedes-Benz users? Join the community slack channel for the latest updates. ",
      closable: true,
      link: {
    ...
    },
    {
      title: "Did you know?",
      content:
        "Mercedes-Benz supports multiple points of integration with cloud storage, machine learning models, and popular tools to automate your machine learning pipeline.",
      closable: true,
      link: {
  ...
  projectSettings: [
    {
      title: "Apply your AWS spend to Mercedes-Benz Enterprise",
      content:
        "Mercedes-Benz Enterprise is now available on the AWS Marketplace so you can use your committed spend to streamline data labeling workflows.",
      closable: true,
      link: {
        label: "Learn more",
    ...
    },
    {
      ...
      link: {
        label: "Learn more",
        url: "https://docs.mercedes-benz.com/guide/prompts_overview#Auto-labeling-with-Prompts",
        params: {
          experiment: "project_settings_tip",
    ...
    },
    {
      title: "Did you know?",
      content:
        "You can increase the quality of your labeled data with reviewer workflows and task agreement scores using Mercedes-Benz Enterprise.",
      closable: true,
      link: {
        label: "Learn more",
        url: "https://docs.mercedes-benz.com/guide/quality",
        params: {
          experiment: "project_settings_tip",
    ...
    },
    {
      ...
      link: {
        label: "Learn more",
        url: "https://mercedes-benz.com/evals/",
        params: {
          experiment: "project_settings_tip",
          treatment: "evals",
        },
    ...
    },
    {
      ...
      link: {
        label: "Learn more",
        url: "https://mercedes-benz.com/platform/",
        params: {
          experiment: "project_settings_tip",
