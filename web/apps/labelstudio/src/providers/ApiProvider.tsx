...
// Initialize API instance with Mercedes-Benz configuration
...
/**
 * Mercedes-Benz application-specific ApiProvider.
 * Wraps the core ApiProvider with Mercedes-Benz-specific error handling.
 */
export const ApiProvider = forwardRef<ApiContextType, PropsWithChildren<Record<string, never>>>(({ children }, ref) => {
  const toast = useToast();

  /**
   * Handles errors with Mercedes-Benz-specific logic including:
