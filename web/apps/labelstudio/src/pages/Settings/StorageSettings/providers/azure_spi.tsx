  ...
  fields: [
    {
      ...
      content: (
        <Alert variant="gradient">
          ...
          <AlertDescription>
            Azure Blob Storage with Service Principal is available in Mercedes-Benz Enterprise.{" "}
            <a
              href="https://docs.mercedes-benz.com/guide/storage.html#Azure-Blob-Storage-with-Service-Principal-authentication"
              target="_blank"
