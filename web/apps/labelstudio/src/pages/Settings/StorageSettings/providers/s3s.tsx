  ...
  fields: [
    {
      ...
      content: (
        <Alert variant="gradient">
          ...
          <AlertDescription>
            Amazon S3 with IAM Role is available in Mercedes-Benz Enterprise.{" "}
            <a
              href="https://docs.mercedes-benz.com/guide/storage.html#Set-up-an-S3-connection-with-IAM-role-access"
              target="_blank"
