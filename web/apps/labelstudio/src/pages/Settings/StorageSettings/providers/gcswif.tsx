  ...
  fields: [
    {
      ...
      content: (
        <Alert variant="gradient">
          ...
          <AlertDescription>
            Google Cloud Storage with Workload Identity Federation is available in Mercedes-Benz Enterprise.{" "}
            <a
              href="https://docs.mercedes-benz.com/guide/storage.html#Google-Cloud-Storage-with-Workload-Identity-Federation-WIF"
              target="_blank"
