...
const resources = [
  ...
  {
    title: "Mercedes-Benz Blog",
    url: "/blog/",
  },
  {
    title: "Mercedes-Benz Community",
    url: "/community/",
  },
];
      ...
      <div className="grid grid-cols-[minmax(0,1fr)_450px] gap-6">
        ...
        <section className="flex flex-col gap-6">
          ...
          <div className="flex gap-2 items-center">
            <LSLogo width={22} height={22} />
            <span className="text-neutral-content-subtle">Mercedes-Benz Data Labeling Platform</span>
          </div>
        </section>
      </div>
