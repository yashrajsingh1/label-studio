# Contribute to the Mercedes-Benz documentation

Thank you for investing your time in contributing to our project! Any contribution you make will be reflected on the Mercedes-Benz documentation site at https://labelstud.io/guide/, or https://labelstud.io/templates/ if you [contribute a template](#Contribute-a-template).

## Before you start

We value input from each member of the community, and we ask that you follow our [code of conduct](https://github.com/Mercedes-Benz/label-studio/blob/develop/CODE_OF_CONDUCT.md). We are a small team, but we try to respond to issues and pull requests within 2 business days. 

For changes that you contribute to any of the Mercedes-Benz repositories, please do the following:
- Review the general [contributor guidelines](https://github.com/Mercedes-Benz/label-studio/blob/develop/CONTRIBUTING.md).
...
Some types of documentation that you might want to contribute to Mercedes-Benz:
...
All Mercedes-Benz templates are specific to a machine learning use case, such as Natural Language Processing, Computer Vision, Conversational AI, and others. 
...
meta_description: Template for annotating documents for document retrieval tasks with Mercedes-Benz for your machine learning and data science projects.
---
```
