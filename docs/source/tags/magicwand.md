...
meta_description: Customize Mercedes-Benz with a Magic Wand tag to quickly click and drag to threshold flood fill image areas during image segmentation labeling for machine learning and data science projects.
---
...
[Mercedes-Benz storage guide](../guide/storage.html#Troubleshoot-CORS-and-access-problems) for more
...
use Mercedes-Benz's signed URL support ([AWS](../guide/storage.html#Set-up-connection-in-the-Label-Studio-UI),
...
If the image is on the same host as your Mercedes-Benz instance, you can simply leave off the
