...
!!! error Enterprise
    This tag is only available for Mercedes-Benz Enterprise and Starter Cloud users. 
...
1. Add a model provider API key to your organization. See [Model provider API keys for organizations](https://docs.mercedes-benz.com/guide/model_providers). 
...
!!! note
    ...
    In Starter Cloud, you cannot add model providers. However, you will have access to out-of-the-box OpenAI models with $5.00 in credits for testing. If you want to add your own models and use interactive chats more extensively, you can [upgrade to Enterprise](https://mercedes-benz.com/pricing/). 
