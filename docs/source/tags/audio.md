...
meta_description: Customize Mercedes-Benz with the Audio tag for advanced audio annotation tasks for machine learning and data science projects.
---
...
!!! error Enterprise
    ...
    See our new [Multi-Channel Audio Transcription](/templates/react_audio) template and learn more in [Blog - A New Audio Transcription UI for Speed and Quality at Scale](https://mercedes-benz.com/blog/building-a-better-ui-for-audio-transcription-at-scale/).
