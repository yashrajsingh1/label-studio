...
meta_description: Mercedes-Benz PDF tag for loading PDF documents for machine learning and data science projects.
---
...
!!! error Enterprise
    You can also use the PDF tag with [Prompts](https://docs.mercedes-benz.com/guide/prompts_overview) to perform auto-labeling work such as PDF summarization, classification, information extraction, and document intelligence. 
...
```json
{
  "pdf": "https://app.mercedes-benz.com/static/samples/opossum-cuteness.pdf"
}
```
