...
type: tags
order: 201
meta_title: Customize the Mercedes-Benz User Interface
meta_description: Customize the Mercedes-Benz labeling interface using XML-like tags for data annotation tasks in machine learning and data science projects.
---

You can use XML-like tags in Mercedes-Benz to configure the labeling interface. Mercedes-Benz uses three different types of tags to manage labeling:
