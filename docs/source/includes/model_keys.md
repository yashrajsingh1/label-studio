...
Each Azure OpenAI key is tied to a specific deployment, and each deployment comprises a single OpenAI model. So if you want to use multiple models through Azure, you will need to create a deployment for each model and then add each key to Mercedes-Benz. 
...
When adding the key to Mercedes-Benz, you are asked for the following information:
...
Once deployed, navigate to the Details page of the deployed model. The information you will need to set up the connection to Mercedes-Benz is under **Endpoint**:
...
4. Add connection to Mercedes-Benz:
