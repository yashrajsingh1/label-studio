...
| [valueType] | <code>url</code> \| <code>json</code> | <code>url</code> | Format of time series data provided. If set to "url" then Mercedes-Benz loads value references inside `value` key, otherwise it expects JSON. |
