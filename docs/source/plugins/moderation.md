...
![Screenshot of moderation modal in Mercedes-Benz](/images/plugins/moderation.png)
 ...
 * work with no errors.
 *
 * The plugin uses Mercedes-Benz's beforeSaveAnnotation event which is triggered before
