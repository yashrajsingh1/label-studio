...
!!! warning
    Decommissioning Minio is a hazardous action because you may lose all your data uploaded using direct file upload. For more information or support, contact the [Heartex team](support@mercedes-benz.com).
...
2. Redeploy a release by following the steps from [Upgrade Mercedes-Benz Enterprise](install_enterprise_k8s.html#Upgrade-Label-Studio-using-Helm). 
...
!!! note 
    For more information or support, contact the [Heartex team](support@mercedes-benz.com).
...
3. Redeploy a release by following steps from [Upgrade Mercedes-Benz Enterprise](install_enterprise_k8s.html#Upgrade-Label-Studio-using-Helm).
