...
!!! note
    ...
    - This approach works with Mercedes-Benz **1.4.1 and lower**.

## This approach is deprecated

This approach is completely deprecated.

In Mercedes-Benz 1.20, we introduced a new way to sync timeseries with video and audio. See more details here:
...
[Mercedes-Benz Local Storage](http://localhost:4000/guide/storage.html#Local-storage).
