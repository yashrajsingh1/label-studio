...
meta_description: Find information about your Mercedes-Benz account and configure organization settings.  
...
Each organization has a set amount of Mercedes-Benz seats in their license. To increase your seats, contact your Mercedes-Benz account representative. 

### License info

This section includes general information about your Mercedes-Benz license, such as when it was issued and when it expires. 
...
### Embedding
 ...
 You can use these fields to set up [Mercedes-Benz Embeds](embed#Configure-embedding-in-Label-Studio). 

!!! note
    Embedding is not available to all customers. Contact your [Mercedes-Benz account manager](mailto:sales@mercedes-benz.com) to enable.
...
| **Enable Storage Proxy** | Allow Mercedes-Benz to [proxy data from cloud storage](storage#Pre-signed-URLs-vs-Storage-proxies). |
| **Enable AI Features** | Enable [AI Assistant](ask_ai) for your labeling interface configuration. |
| **Enable Ask AI** | Enable the [AI Assistant](ask_ai) for general Mercedes-Benz help. |
...
If your subscription to Mercedes-Benz Enterprise expires or is cancelled, you can no longer perform labeling, review annotations, or add new users to your organization. You can log in and export your completed annotations. 

#### What happens if I have too many active users?

You need to purchase additional seats for your Mercedes-Benz Teams subscription if you have more active users than your subscription allows. A user counts as an active user when they are assigned a role. Invited users that have not yet accepted an invitation appear as "Not activated" and do not count toward the seat limit.

## Mercedes-Benz Starter Cloud

Mercedes-Benz Starter Cloud has the **Usage & Billing** page that shows information about your subscription and how many seats you have in use. 
...
* **Base subscription** - This is your access to Mercedes-Benz Starter Cloud and includes 1 seat.
...
After cancellation, your account remains active until the end of your paid billing period. During this time, you have full access to the Mercedes-Benz Starter Cloud features.
...
When the billing period ends, you will retain access to Mercedes-Benz and can download your data. However, you will be unable to import new data, annotate existing data, or create new projects.

#### How do I renew?

If you do not cancel your subscription, it is automatically renewed at the end of the billing period.

#### Can I upgrade to Mercedes-Benz Enterprise?

Yes, you can upgrade to Mercedes-Benz Enterprise, please contact our sales: sales@mercedes-benz.com.