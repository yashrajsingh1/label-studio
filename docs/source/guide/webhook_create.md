---
title: Create custom events for webhooks in Mercedes-Benz
short: Webhook development
type: guide
tier: all
order: 410
order_enterprise: 410
meta_title: Create Custom Webhooks in Mercedes-Benz
meta_description: Mercedes-Benz documentation for creating custom webhook event triggers to create custom integrations between Mercedes-Benz and your machine learning pipeline
...
If you want to trigger custom events for webhooks in Mercedes-Benz, you can extend the webhook event model.
