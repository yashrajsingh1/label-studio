...
meta_description: Update your user account and settings in Mercedes-Benz
...
After you create an account in Mercedes-Benz, you can update the following:
...
| Action                  | Description                                                                      |
| ----------------------- | -------------------------------------------------------------------------------- |
| **Export Hotkeys**      | Generate a JSON file that you can share with other Mercedes-Benz users.           |
...
On this page, you can find information about your organization, such as when the organization was created and the email address of the Owner (the user who initially created the Mercedes-Benz organization).
...
While personal access tokens work seamlessly with the Mercedes-Benz SDK, if you are using HTTP API requests, you will need to take extra steps. See [Personal access tokens and the API](access_tokens#Personal-access-tokens-and-the-API). 
