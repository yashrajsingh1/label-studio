...
meta_description: How to set up model providers for AI features in Mercedes-Benz. 
...
!!! note
    These models are not used with the Mercedes-Benz [AI Assistant](ask_ai). 
...
If you are restricting network access to your resource, you may need to whitelist Mercedes-Benz IP addresses ([IP ranges on SaaS](saas#Outbound-Connections-IP-Addresses)) when configuring network security.
