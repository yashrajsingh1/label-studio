...
meta_title: Comment in Mercedes-Benz Enterprise
...
Comments are a Mercedes-Benz Enterprise feature that allows communication between reviewers and annotators:
