...
meta_description: Manage existing user accounts in Mercedes-Benz Community edition
section: "Manage Your Organization"
date: 2024-02-06 16:36:44
---

!!! error Enterprise
    In Mercedes-Benz Community Edition, there are relatively limited options available for user management. 
    
    In Mercedes-Benz Enterprise, you can set roles for users, restrict their permissions, delete and deactivate users, and view detailed logs of user actions. For more information about the user management capabilities of Mercedes-Benz Enterprise, see [User management overview](https://docs.mercedes-benz.com/guide/manage_users) in the Enterprise documentation. To start a free trial, [click here](https://app.heartex.com/user/trial).  

## Retrieve user info from the command line

You can retrieve information about a user, including the API user token for a user, from the command line after starting Mercedes-Benz.
...
Users can also retrieve their own tokens from the Mercedes-Benz app. For more information, see [Access Tokes](access_tokens). 


## Review existing accounts in Mercedes-Benz

You can view the organization user list from Mercedes-Benz:
...
On the server running Mercedes-Benz, run the following command. And then when prompted, type the username and the new password:
