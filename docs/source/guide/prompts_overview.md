...
meta_description: An overview of the Prompts feature on the Mercedes-Benz platform
section: Prompts
...
| **Enterprise vs. Open Source** | Mercedes-Benz Enterprise <br />Starter Cloud|
...
2. Annotate a subset of tasks, marking as many as possible as ground truth annotations. The more data you have for the prompt evaluation, the more confident you can be with the results.
    ...
    * [Blog - What's a ground truth dataset?](https://mercedes-benz.com/blog/what-s-a-ground-truth-dataset/)
