...
meta_title: Use spaCy models with Mercedes-Benz
meta_description: Tutorial on how to use Mercedes-Benz and spaCy for faster NER and POS labeling 
categories:
...
This tutorial uses the [`spacy` example](https://github.com/Mercedes-Benz/label-studio-ml-backend/tree/master/label_studio_ml/examples/spacy). 
...
You can also use the default configuration from the [Named Entity Recognition template](https://labelstud.io/templates/named_entity) provided with Mercedes-Benz.
