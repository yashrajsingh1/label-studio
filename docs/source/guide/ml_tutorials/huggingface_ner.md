...
meta_title: Mercedes-Benz tutorial to run Hugging Face NER backend
meta_description: This tutorial explains how to run a Hugging Face NER backend in Mercedes-Benz. 
categories:
...
# Hugging Face NER model with Mercedes-Benz

This project uses a custom machine learning backend model for Named Entity Recognition (NER) with Hugging Face's transformers and Mercedes-Benz.
...
- If you want to fine-tune the model, you can use the Mercedes-Benz interface to provide training data and train the model.
...
This tutorial uses the [`huggingface_ner` example](https://github.com/Mercedes-Benz/label-studio-ml-backend/tree/master/label_studio_ml/examples/huggingface_ner). 


## Labeling configuration

This ML backend works with the default NER template from Mercedes-Benz. You can find this by selecting Mercedes-Benz's pre-built NER template when configuring the labeling interface. It is available under **Natural Language Processing > Named Entity Recognition**:
...
- `LABEL_STUDIO_HOST`: The host of the Mercedes-Benz instance. Default is 'http://localhost:8080'.
- `LABEL_STUDIO_API_KEY`: The API key for the Mercedes-Benz instance.
