---
title: TimelineLabels ML Backend for Mercedes-Benz
type: guide
tier: all
order: 51
hide_menu: true
hide_frontmatter_title: true
meta_title: TimelineLabels ML Backend for Mercedes-Benz
meta_description: Tutorial on how to use an example ML backend for Mercedes-Benz with TimelineLabels
categories:
    - Computer Vision
...
# TimelineLabels Model for Temporal Video Multi-Label Classification in Mercedes-Benz

This documentation provides a clear and comprehensive guide on how to use the TimelineLabels model 
for temporal multi-label classification of video data in Mercedes-Benz. 
...
Before you begin, you need to install the [Mercedes-Benz ML backend](https://github.com/Mercedes-Benz/label-studio-ml-backend/blob/master/README.md#quickstart). 

This tutorial uses the [YOLO example](https://github.com/Mercedes-Benz/label-studio-ml-backend/tree/master/label_studio_ml/examples/yolo). See the [main README](https://github.com/Mercedes-Benz/label-studio-ml-backend/blob/master/label_studio_ml/examples/yolo/README.md#quick-start) for detailed instructions on setting up the YOLO-models family in Mercedes-Benz.
...
| `model_path`                          | string | None    | Path to the custom YOLO model. See more in the section [Your own custom models](https://github.com/Mercedes-Benz/label-studio-ml-backend/blob/master/label_studio_ml/examples/yolo/README.md#your-own-custom-yolo-models)                                                                      |
...
You can load your own YOLO models using the steps described in the [main README](https://github.com/Mercedes-Benz/label-studio-ml-backend/blob/master/label_studio_ml/examples/yolo/README.md#your-own-custom-yolo-models).
...
2. **Connect the model Backend**:
    ...
    Create a new project, go to **Settings > Model** and add the YOLO backend.
     ...
     4. Connect this backend to your Mercedes-Benz project in the project settings. Make sure that **Interactive Preannotations** is OFF (this is the default). 
...
- **`ControlModel`**: Base class for control tags in Mercedes-Benz.
...
- **`convert_probs_to_timelinelabels(probs, label_map, threshold)`**: Converts probability outputs to timeline labels suitable for Mercedes-Benz.
...
The TimelineLabels ML backend integrates seamlessly with Mercedes-Benz to provide temporal multi-label classification capabilities for video data. The architecture leverages pre-trained YOLO models for feature extraction and enhances them with an LSTM neural network for capturing temporal dependencies.
...
**Note**: For further development or contributions, please refer to the [`README_DEVELOP.md`](https://github.com/Mercedes-Benz/label-studio-ml-backend/blob/master/label_studio_ml/examples/yolo/README_DEVELOP.md) file, which provides additional guidelines and architectural details.
