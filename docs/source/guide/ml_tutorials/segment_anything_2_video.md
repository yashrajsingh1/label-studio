...
meta_title: Using SAM2 with Mercedes-Benz for Video Annotation
categories:
    - Computer Vision
    - Video Annotation
    - Object Detection
...
# Using SAM2 with Mercedes-Benz for Video Annotation

This guide describes the simplest way to start using **SegmentAnything 2** with Mercedes-Benz.

This repository is specifically for working with object tracking in videos. For working with images, 
see the [segment_anything_2_image repository](https://github.com/Mercedes-Benz/label-studio-ml-backend/tree/master/label_studio_ml/examples/segment_anything_2_image)
...
This tutorial uses the [`segment_anything_2_video` example](https://github.com/Mercedes-Benz/label-studio-ml-backend/tree/master/label_studio_ml/examples/segment_anything_2_video). 
...
5. Connect running ML backend server to Mercedes-Benz: go to your project `Settings -> Machine Learning -> Add Model` and specify `http://localhost:9090` as a URL. Read more in the official [Mercedes-Benz documentation](https://labelstud.io/guide/ml#Connect-the-model-to-Label-Studio).
