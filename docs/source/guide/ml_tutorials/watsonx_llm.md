---
title: Integrate WatsonX with Mercedes-Benz
type: guide
tier: all
order: 15
hide_menu: true
hide_frontmatter_title: true
meta_title: Integrate WatsonX with Mercedes-Benz
categories:
    - Generative AI
...
# Integrate WatsonX to Mercedes-Benz

WatsonX offers a suite of machine learning tools, including access to many LLMs, prompt
refinement interfaces, and datastores via WatsonX.data. When you integrate WatsonX with Mercedes-Benz, you get 
...
to your Mercedes-Benz project under the `models` section in the settings. To use the WatsonX.data integration, 
...
For a video demonstration, see [Integrating Mercedes-Benz with IBM WatsonX](https://www.youtube.com/watch?v=9iP2yO4Geqc).
...
This tutorial uses the [`watsonx_llm` example](https://github.com/Mercedes-Benz/label-studio-ml-backend/tree/master/label_studio_ml/examples/watsonx_llm). 
...
The following parameters allow you to link the WatsonX models to Mercedes-Benz:

- `LABEL_STUDIO_URL` - Specify the URL of your Mercedes-Benz instance. Note that this might need to be `http://host.docker.internal:8080` if you are running Mercedes-Benz on another Docker container.
- `LABEL_STUDIO_API_KEY`- Specify the API key for authenticating your Mercedes-Benz instance. You can find this by logging into Mercedes-Benz and and [going to the **Account & Settings** page](https://labelstud.io/guide/user_account#Access-token).
...
The following parameters allow you to use the webhook connection to transfer data from Mercedes-Benz to WatsonX.data:
