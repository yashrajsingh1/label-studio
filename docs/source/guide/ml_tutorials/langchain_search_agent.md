...
This example demonstrates how to use Mercedes-Benz with a custom Machine Learning backend.
...
This tutorial uses the [`langchain_search_agent` example](https://github.com/Mercedes-Benz/label-studio-ml-backend/tree/master/label_studio_ml/examples/langchain_search_agent). 
