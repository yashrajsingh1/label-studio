...
meta_description: Mercedes-Benz tutorial for computer vision that showcases transfer learning for images using PyTorch and Mercedes-Benz.
...
This example explains the basics of computer vision with Mercedes-Benz and [PyTorch](https://pytorch.org/).
