...
meta_description: Use the interactive substring matching model for labeling NER tasks in Mercedes-Benz
categories:
...
This tutorial uses the [`interactive_substring_matching` example](https://github.com/Mercedes-Benz/label-studio-ml-backend/tree/master/label_studio_ml/examples/interactive_substring_matching). 
