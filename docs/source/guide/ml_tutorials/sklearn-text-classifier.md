...
meta_description: Mercedes-Benz tutorial for text classification using Scikit-Learn and Mercedes-Benz.
...
This tutorial explains the basics of using a Machine Learning (ML) backend with Mercedes-Benz using a simple text classification model powered by the [scikit-learn](https://scikit-learn.org/stable/) library.
