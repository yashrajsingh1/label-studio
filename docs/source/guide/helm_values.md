---
title: Available Helm values for Mercedes-Benz Helm Chart
short: Available Helm values
tier: all
type: guide
order: 72
order_enterprise: 74
meta_title: Available Helm values for Mercedes-Benz Helm Chart
meta_description: For cases when you want to customize your Mercedes-Benz Kubernetes deployment, review these available Helm values that you can set in your Helm chart.
...
when configuring your Mercedes-Benz deployment on Kubernetes. See [Deploy Mercedes-Benz on Kubernetes](install_k8s) for more.
...
Refer to these tables with available Helm chart values for your `values.yaml` file
when configuring your Mercedes-Benz deployment on Kubernetes. See [Deploy Mercedes-Benz on Kubernetes](install_enterprise_k8s) for more.
...
Parameters specific to the `app` portion of the Mercedes-Benz deployment.
...
Parameters specific to the `rqworkers` service of your Mercedes-Benz Enterprise deployment.
...
## Mercedes-Benz Enterprise parameters

| Parameter                                 | Description                                                                        | Default   |
|-------------------------------------------|------------------------------------------------------------------------------------|-----------|
| `enterprise.enabled`                      | Enable Enterprise features                                                         | `false`   |
| `enterprise.enterpriseLicense.secretName` | Name of an existing secret holding the Mercedes-Benz Enterprise license information | `""`      |
...
The `global.extraEnvironmentVars` section can be used to configure environment properties of Mercedes-Benz.

Any key value put under this section translates to environment variables used to control Mercedes-Benz's configuration. Every key is upper-cased before setting the environment variable.
...
!!! note
    If you are deploying to a production environment, you should set `SSRF_PROTECTION_ENABLED: true`. See [Secure Mercedes-Benz](security#Enable-SSRF-protection-for-production-environments). 
