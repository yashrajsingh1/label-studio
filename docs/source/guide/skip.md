...
meta_title: Skipping project tasks in Mercedes-Benz
...
!!! error Enterprise
    Task skipping, and how tasks can be skipped, is highly configurable in Mercedes-Benz Enterprise and Starter Cloud. For more information, see [the Enterprise documentation](https://docs.mercedes-benz.com/guide/skip). 
