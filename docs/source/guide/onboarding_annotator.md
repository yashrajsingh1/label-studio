---
title: How to Annotate in Mercedes-Benz
...
Welcome to the Mercedes-Benz platform!  
...
There are a variety of use cases that can be implemented via Mercedes-Benz, including, but not limited to, pre-training, post-training, benchmarking, etc.
...
Usually, after you submit your task, Mercedes-Benz Enterprise sends off all submitted annotated tasks to reviewers, who verify if there are any errors.  Exact steps vary by team, but most workflows follow a pattern like: annotation → review and quality assurance → production.
...
* **Proper Account Permissions**  
  When your Mercedes-Benz account is created, your team lead needs to add you to the appropriate projects for you to work on.  Sometimes, you may be added onto more than one, so it is important that you ensure you have access to and are working on your highest priority project.
...
### How do I access Mercedes-Benz?

When you initially receive access to Mercedes-Benz, you will receive an email and a link to sign up. 

To access your company’s projects, use the information you provided at sign up to log in. (Location link may vary depending on whether your team works directly on Mercedes-Benz or in your company’s own integrated workspace.)  
...
4. Follow the protocol given to you by your lead. In this example, the annotator is selecting the car in the image. It’s possible that your project has been configured to allow a pop up of the annotation instructions, right in Mercedes-Benz. If this is true, you can see it by clicking on the circle with an i inside of it icon on the bottom of the annotation screen, to the left of the Submit button. 
