...
Connect your [Microsoft Azure Blob storage](https://docs.microsoft.com/en-us/azure/storage/blobs/storage-blobs-introduction) container with Mercedes-Benz. For details about how Mercedes-Benz secures access to cloud storage, see [Secure access to cloud storage](security.html#Secure-access-to-cloud-storage).
...
3. Under **Blob service** add the following rule:
   ...
   * **Allowed origins:** `https://app.mercedes-benz.com` (or the domain you are using)
...
<table style="width: 100%; border-collapse: collapse;">
  ...
  <tr>
    ...
    <td>Enable this option if you want to delete annotations stored in the container when they are deleted in Mercedes-Benz.</td>
  </tr>
...
In Mercedes-Benz Enterprise, you can use Azure Service Principal authentication to securely connect Mercedes-Benz to Azure Blob Storage without using storage account access keys.

For more information, see [Azure Blob Storage with Service Principal](https://docs.mercedes-benz.com/guide/storage_azure.html#Azure-Blob-Storage-with-Service-Principal) in our Enterprise documentation.

</div>

<div class="enterprise-only">

You can use Azure Service Principal authentication to securely connect Mercedes-Benz Enterprise to Azure Blob Storage without using storage account access keys. 
...
| | |
| --- | --- |
| Storage Title | Enter a name for the storage connection to appear in Mercedes-Benz. | 
...
| Client ID | Specify the **Application (client) ID** from your App Registration. |
| Client Secret | Specify the **Value** of the client secret you copied earlier. |
| Can delete objects from storage | Enable this option if you want to delete annotations stored in the bucket when they are deleted in Mercedes-Benz. Your credentials must include the ability to delete bucket objects. |
