...
short: Google SAML SSO with Mercedes-Benz Setup Example
tier: enterprise
order: 253
meta_title: Google SAML SSO with Mercedes-Benz Setup Example
meta_description: Mercedes-Benz Enterprise documentation for setting up Google as Identity Provider for SAML SSO Setup Example.
hide_sidebar: true
---

You can set up Mercedes-Benz to use Google's IdP for SSO. 
...
* Your Mercedes-Benz user role must be Owner or Administrator. 


## Step 1: Get Mercedes-Benz ACS endpoints as a Service Provider (SP)

1. **Access Mercedes-Benz SSO settings:**
   - Log in to Mercedes-Benz with an account that has the Owner or Administrator role.
...
2. **Add a new SAML app:**
   ...
   - Enter a name for the app (e.g. "Mercedes-Benz") and click **Continue**.

    <img src="/images/google-saml/2-add-app.png" class="gif-border">

3. **Download IdP metadata:**
   - When given the option, download the IdP metadata file for your new app. This file contains all the necessary information to configure Mercedes-Benz.
...
4. **Configure SAML settings:**
   - In the **Service Provider Details** section, enter the following:
     - **ACS URL**: Paste the ACS URL copied from Mercedes-Benz.
     - **Entity ID**: Use the same URL as the ACS URL.
     - **Start URL**: (Optional) You can leave this blank or use the **Login URL** from Mercedes-Benz.
...
## Step 4: Complete configuration in Mercedes-Benz

1. **Upload IdP Metadata:**
   - Return to the Mercedes-Benz SSO & SAML settings page.
...
2. **Assign the Mercedes-Benz application to the group:**
...
**Log in using SSO:**
   - Navigate to the Mercedes-Benz login page.
   - Click the **SSO Login** button and enter your company domain if prompted.
   - You should be redirected to the Google SSO login page. After successful authentication, you will be redirected back to Mercedes-Benz.

<img src="/images/google-saml/15-lse-sso-login.png" class="gif-border">

## Additional notes

- If you encounter any issues, verify that the SAML attributes and URLs are correctly configured in both Mercedes-Benz and Google Admin Console.

For more detailed information, you can refer to the
- [Mercedes-Benz SSO setup guide](auth_setup)
