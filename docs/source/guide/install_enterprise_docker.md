---
title: Install Mercedes-Benz Enterprise On-premises using Docker Compose
short: Install using Docker
type: guide
tier: enterprise
order: 0
order_enterprise: 75
meta_title: Install Mercedes-Benz Enterprise on-premises using Docker
meta_description: Install, back up, and upgrade Mercedes-Benz Enterprise with Docker to create machine learning and data science projects on-premises.
section: "Install & Setup"
parent_enterprise: "install_enterprise"
---

Install Mercedes-Benz Enterprise on-premises if you need to meet strong privacy regulations, legal requirements, or want to manage a custom installation on your own infrastructure using Docker or public cloud. If you want to use a different installation method:
- You can use Kubernetes and Helm to deploy Mercedes-Benz Enterprise in the cloud. See [Deploy Mercedes-Benz Enterprise on Kubernetes](install_enterprise_k8s.html).
- You can run Mercedes-Benz Enterprise in an airgapped environment, and no data leaves your infrastructure. See [Install Mercedes-Benz Enterprise without public internet access](install_k8s_airgapped).

See [Secure Mercedes-Benz](security.html) for more details about security and hardening for Mercedes-Benz Enterprise.

!!! note
    Docker deployments are more suitable for proof-of-concept builds and small projects. For production environments and larger deployments, we strongly recommend using Kubernetes. Kubernetes deployments provide better scalability, reliability, and access to advanced features such as Prompts. See [Deploy Mercedes-Benz Enterprise on Kubernetes](install_enterprise_k8s.html) for more information.

To install Mercedes-Benz Community Edition, see [Install Mercedes-Benz](https://labelstud.io/guide/install). This page is specific to the Enterprise version of Mercedes-Benz.
...
## Install Mercedes-Benz Enterprise using Docker
...
### Prerequisites
Make sure you have an authorization token to retrieve Docker images and a current license file. If you are a Mercedes-Benz Enterprise customer and do not have access, [email support](mailto:support@mercedes-benz.com) or open a ticket through our [support portal](https://support.mercedes-benz.com/) to receive an authorization token and a copy of your license file.

Make sure [Docker Compose](https://docs.docker.com/compose/install/) is installed on your system.

After you install Mercedes-Benz Enterprise, the app is automatically connected to the following running services:
- PostgresSQL (versions >=13)
- Redis (version >=6.0)

### Log in to a Docker registry

You must be authorized to access Mercedes-Benz Enterprise images. 
...
After you retrieve the latest Mercedes-Benz Enterprise image, add the license file. You can't start the Docker image without a license file. 
...
To run Mercedes-Benz Enterprise in production, start it using [Docker compose](https://docs.docker.com/compose/). This configuration lets you connect Mercedes-Benz to external databases and services.
...
To check the version of the Mercedes-Benz Enterprise Docker image, use the [`docker ps`](https://docs.docker.com/engine/reference/commandline/ps/) command on the host. 
