...
meta_title: Dashboard in Mercedes-Benz
meta_description: Use Mercedes-Benz dashboards to monitor performance and progress.
section: "Create & Manage Projects"
---

You can use the Mercedes-Benz Enterprise dashboards to help visualize your labeling progress across projects and resources. 

See the following video for a brief overview of the analytics available in Mercedes-Benz Enterprise:
