---
title: Upgrade Mercedes-Benz Enterprise
short: Upgrade Mercedes-Benz
tier: enterprise
type: guide
order: 0
order_enterprise: 76
meta_title: Upgrade Mercedes-Benz Enterprise
meta_description: Steps you should take when upgrading Mercedes-Benz Enterprise.
...
If you are using Mercedes-Benz Enterprise Cloud, all upgrades and updates are automatically deployed. 

If you are using the on-premises version of Mercedes-Benz, you will need to take additional steps. 
...
If you installed Mercedes-Benz Enterprise in a Kubernetes environment, you can upgrade using Helm: 

1. Determine the latest tag version of Mercedes-Benz Enterprise and add/replace the following in your `ls-values.yaml` file: 
   ```yaml
   global:
     image:
...
If you installed Mercedes-Benz Enterprise through Docker, you can upgrade using the following steps:

1. Edit `docker-compose.yaml` to update the Mercedes-Benz Enterprise version. 
2. Run Docker:
