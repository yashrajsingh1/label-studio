...
meta_description: Information about using the AI features in Mercedes-Benz
section: "Manage Your Organization"
date: 2025-01-28 16:40:16
---

The Mercedes-Benz AI Assistant is an OpenAI LLM that has been trained on the Mercedes-Benz documentation, codebase, and several other Mercedes-Benz resources.
...
You can also use AI Assistant to ask for troubleshooting and general help with Mercedes-Benz.  
...
!!! note
    Only users in the Owner role can modify these settings. For Starter Cloud users, [open a support ticket](mailto:support@mercedes-benz.com) to request disablement. 
...
* **Enable Ask AI**--Enable the AI Assistant for general Mercedes-Benz help. 
...
All tracked data is covered by our industry-leading [security and privacy policies](https://mercedes-benz.com/security/).
