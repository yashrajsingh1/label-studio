...
meta_description: User management options available in Mercedes-Benz Enterprise
...
Mercedes-Benz Enterprise user management options include:
...
* **SSO/SAML and SCIM Integration**: For enterprises using Single Sign-On (SSO) or System for Cross-domain Identity Management (SCIM), Mercedes-Benz Enterprise allows mapping groups to roles at both the organization and project levels. For more information, see [SSO and SAML setup](auth_setup) and [SCIM2 setup](scim_setup). 
