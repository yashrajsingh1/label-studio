...
1. In Mercedes-Benz, click the plus icon next to **Workspaces** in the menu on the right:
...
Each user has a personal Sandbox workspace that they can use to experiment with project settings and get familiar with Mercedes-Benz. Only you can see projects within your sandbox. 
...
Users are not sent notifications when they are added to a workspace. The workspace appears when they log in to Mercedes-Benz or refresh their page.
