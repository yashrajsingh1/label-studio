...
meta_description: Mercedes-Benz Enterprise documentation for setting up Ping Federate & Ping Identity & PingOne SAML SSO Setup Example.
hide_sidebar: true
---
...
2. Select `Manual Enter`, enter URLs from the Mercedes-Benz Enterprise SAML SSO page.
...
## Mercedes-Benz Enterprise Settings 
