...
You can use this page to customize certain permissions for roles. For information about Mercedes-Benz Enterprise roles and default permissions, see [User roles and permissions](admin_roles).
