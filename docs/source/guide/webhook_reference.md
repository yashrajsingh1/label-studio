...
meta_title: Mercedes-Benz Webhook Event Reference 
meta_description: Mercedes-Benz reference documentation for webhook event fields and payloads sent from Mercedes-Benz for integration with your machine learning pipeline. 
...
Mercedes-Benz includes several types of webhook events that trigger when specific actions occur. Refer to the details on this page to determine what information is included in the payload of each webhook event. For details about how to use webhooks and to set up webhooks in Mercedes-Benz, see [Set up webhooks in Mercedes-Benz](webhooks.html). To create your own webhooks in Mercedes-Benz to trigger events when specific actions happen, see [Create custom events for webhooks in Mercedes-Benz](webhook_create.html). 

Webhooks sent from Mercedes-Benz include the following:
...
The HTTP POST payloads that Mercedes-Benz sends to the configured webhook URLs include the headers that you set up when you [configure the webhook](webhooks.html).
...
Sent when a task is created in Mercedes-Benz. See how to [set up a webhook for this event](webhooks.html). 
...
Sent when a task is deleted from Mercedes-Benz. See how to [set up a webhook for this event](webhooks.html).
...
## Annotation Created
Sent when an annotation is created for a task in Mercedes-Benz. See how to [set up a webhook for this event](webhooks.html).
