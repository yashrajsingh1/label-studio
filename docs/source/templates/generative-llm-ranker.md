...
order: 906
is_new: t
meta_title: Create a ranked dataset for building a RAG system for LLMs with Mercedes-Benz
meta_description: Create a ranked dataset for building a RAG system for LLMs with Mercedes-Benz for your machine learning and data science projects.
---
...
4. Build [the preference model for RLHF](https://github.com/Mercedes-Benz/RLHF)
...
Looking for a model to get started with the fine-tuning process? Check out [our guide on the Mercedes-Benz Blog](https://labelstud.io/blog/five-large-language-models-you-can-fine-tune-today/).
...
!!! info Tip
    Need a hand getting started with Mercedes-Benz? Check out our [Zero to One Tutorial](https://labelstud.io/blog/zero-to-one-getting-started-with-label-studio/).

1. Create new project in Mercedes-Benz
...
Using the Python SDK, import the dataset with input prompts into Mercedes-Benz using the `PROJECT_ID` of the project you've just created.
...
Using python SDK you can export the dataset with annotations from Mercedes-Benz
