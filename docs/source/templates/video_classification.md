...
meta_description: Template for video classification tasks with Mercedes-Benz for your machine learning and data science projects.
---
...
Use the [Video](/tags/video.html) object tag to display video clips in Mercedes-Benz Enterprise:
```xml
<Video name="video" value="$video"/>
```
...
Use the [HyperText](/tags/hypertext.html) tag to display video clips to annotators in Mercedes-Benz:
```xml
<HyperText name="video" value="$html"></HyperText>
```
