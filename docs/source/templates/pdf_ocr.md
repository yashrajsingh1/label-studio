...
!!! error Enterprise
    This template requires the `OcrLabels` tag, which can only be used in Mercedes-Benz Enterprise.
...
* **`Pdf`**
    ...
    This will display your PDF natively in Mercedes-Benz, allowing you to zoom in and rotate as needed. 
