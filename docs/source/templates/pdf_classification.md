...
meta_description: Template for classifying PDF data with Mercedes-Benz for your machine learning and data science projects.
---
...
Mercedes-Benz does not support labeling PDF-formatted files directly. You should use the `embed` tag inside of your data for pdf loading:
