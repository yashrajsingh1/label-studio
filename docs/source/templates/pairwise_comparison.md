...
meta_description: Template for performing pairwise classification and comparison tasks with Mercedes-Benz for your machine learning and data science projects.
---

<img src="/images/templates/pairwise-classification.png" alt="" class="gif-border" width="552px" height="408px" />

Perform pairwise classification and comparison of different objects with Mercedes-Benz using this template.
