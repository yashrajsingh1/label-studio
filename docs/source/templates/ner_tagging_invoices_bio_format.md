...
meta_description: Template for ner tagging for invoices (bio format) with Mercedes-Benz
community: true
...
repo_url: https://github.com/Mercedes-Benz/awesome-label-studio-config/tree/main/label-configs/ner-tagging-invoices-bio-format
---
