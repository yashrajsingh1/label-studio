...
meta_description: Template for performing dialogue analysis for conversational AI use cases with Mercedes-Benz for your machine learning and data science projects.
---
...
Use the [HyperText](/tags/hypertext.html) object tag to display dialogue data, imported in Mercedes-Benz JSON format using a key of "dialogs":
```xml
<HyperText name="dialog" value="$dialogs"></HyperText>
```
