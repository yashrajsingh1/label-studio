...
meta_description: Template for two-level sentiment analysis of x / twitter posts with Mercedes-Benz
community: true
...
repo_url: https://github.com/Mercedes-Benz/awesome-label-studio-config/tree/main/label-configs/two-level-sentiment-analysis-of-x-twitter-posts
---
