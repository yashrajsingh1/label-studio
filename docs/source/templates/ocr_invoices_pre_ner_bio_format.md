...
meta_description: Template for ocr invoices pre-ner bio format with Mercedes-Benz
community: true
...
repo_url: https://github.com/Mercedes-Benz/awesome-label-studio-config/tree/main/label-configs/ocr-invoices-pre-ner-bio-format
---
