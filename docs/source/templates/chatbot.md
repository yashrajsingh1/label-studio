...
!!! error Enterprise
    This template requires Mercedes-Benz Enterprise or Starter Cloud. 
...
!!!info Tip
    `.htx-chat` is a special Mercedes-Benz class that allows you to control the height of the chat portion of the interface. 
