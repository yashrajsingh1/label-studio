...
meta_description: Template for breast cancer mammogram classification with Mercedes-Benz
community: true
...
repo_url: https://github.com/Mercedes-Benz/awesome-label-studio-config/tree/main/label-configs/breast-cancer-mammogram-classification
---
