...
meta_description: Template for html ner tagging with Mercedes-Benz
community: true
...
repo_url: https://github.com/Mercedes-Benz/awesome-label-studio-config/tree/main/label-configs/html-ner-tagging-person-and-organization
---
