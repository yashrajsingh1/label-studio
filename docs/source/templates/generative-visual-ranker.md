...
order: 401
is_new: t
meta_title: Create a ranked dataset for text-to-image models with Mercedes-Benz
meta_description: Template for creating a ranked dataset for text-to-image models with Mercedes-Benz for your machine learning and data science projects.
---
...
1. Create a  new project in Mercedes-Benz
...
Using python SDK you can import the dataset with input prompts into Mercedes-Benz. With the `PROJECT_ID` of the project
...
Using the Python SDK you can export the dataset with annotations from Mercedes-Benz.
