...
meta_description: Template for creating dataset for supervised LLM fine-tuning with Mercedes-Benz for your machine learning and data science projects.
---
...
<a href="https://app.mercedes-benz.com/b/MTk1"
...
Each JSON item will be rendered as a separate task in Mercedes-Benz to complete the response.
...
Using the Python SDK you can import the dataset with input prompts into Mercedes-Benz. With the `PROJECT_ID` of the project
...
After you've labeled enough tasks, you can export the dataset in the following raw Mercedes-Benz JSON format:
