...
This template uses the example available here: [Multi-turn Chat Labeling: Evaluating Virtual Assistant Conversations](https://github.com/Mercedes-Benz/label-studio-examples/blob/main/multi-turn-chat/Readme.md)

You can use this example to evaluate multi-turn chat conversations in Mercedes-Benz, identifying areas to enhance your virtual assistant’s performance and user experience.

For this example, you will need the following:

- Mercedes-Benz instance
- Mercedes-Benz SDK (`pip install label-studio-sdk`)
...
To build your own template XML, you will need to follow the steps outlined in the following notebook: [**Evaluating Virtual Assistant Conversations.ipynb**](https://github.com/Mercedes-Benz/label-studio-examples/blob/main/multi-turn-chat/Evaluating%20Virtual%20Assistant%20Conversations.ipynb)
