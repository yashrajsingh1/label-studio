...
* `<Pairwise>` - The `Pairwise` tag is used to display the selection element. It presents the options for the user to click and select. Read more about [Mercedes-Benz template for pairwise comparison](generative-pairwise-human-preference).
