...
!!! error Enterprise
    If you are performing OCR annotation and you are a Mercedes-Benz Enterprise users, see [OCR Labeling for PDFs](pdf_ocr).

<a href="https://app.mercedes-benz.com/b/MTk4"
...
```
Access-Control-Allow-Origin: https://app.mercedes-benz.com
