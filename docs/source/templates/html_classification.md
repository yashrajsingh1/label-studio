...
meta_description: Template for classifying HTML documents with Mercedes-Benz for your machine learning and data science projects.
---
...
The [HyperText](/tags/hypertext.html) object tag displays the website content, specified in the `text` key of Mercedes-Benz JSON format or imported as plain text.
```xml
    <HyperText name="web_page" value="$text"/>
```
