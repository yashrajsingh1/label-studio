...
!!! note
    **Requirements:** Mercedes-Benz >= 1.20
...
<!-- {
  ...
  "accel_data": "https://app.mercedes-benz.com/samples/time-series.csv?time=time&values=accel_x%2Caccel_y&sep=%2C&tf=%H:%M:%S.%f",
  "gyro_data": "https://app.mercedes-benz.com/samples/time-series.csv?time=time&values=gyro_x%2Cgyro_y&sep=%2C&tf=%H:%M:%S.%f"
}
-->
```
