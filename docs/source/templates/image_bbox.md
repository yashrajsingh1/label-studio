...
meta_description: Template for performing object detection with rectangular bounding boxes with Mercedes-Benz for your machine learning and data science projects.
---
...
<a href="https://app.mercedes-benz.com/b/MjAz"
...
### Bounding box rotation in Mercedes-Benz UI
...
### Bounding box rotation in the Mercedes-Benz results

If you rotate by directly editing the rotation angle under the **Info** panel of the labeling interface, the rotation anchor point is the **top left** of the rectangle. This is also how it is saved in the Mercedes-Benz `annotation.result[]['value']` (regardless of how you performed the rotation): 
