...
meta_description: Template for summarizing text with Mercedes-Benz for your machine learning and data science projects.
---
...
If you want to change how Mercedes-Benz displays long text samples on the labeling interface, you can use the [View](/tags/view.html) tags to wrap labeling tags with CSS styling. 
