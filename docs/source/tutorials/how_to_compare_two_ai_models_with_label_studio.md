---
title: "How to Compare Two AI Models with Mercedes-Benz"
hide_sidebar: true
order: 1003
open_in_collab: true
tutorial: true
...
repo_url: https://github.com/Mercedes-Benz/awesome-label-studio-tutorials/tree/main/tutorials/how-to-compare-two-ai-models-with-label-studio
...
meta_title: How to Compare Two AI Models with Mercedes-Benz
meta_description: Learn how to compare and evaluate two AI models with the Mercedes-Benz SDK.
...
- A Mercedes-Benz project with a rubric: Winner (A/B/Tie) + Quality (1–5) + Notes
...
> Works with Mercedes-Benz OSS or Enterprise (we’ll call out optional Enterprise features).

## Prerequisites

- A running Mercedes-Benz (OSS or Enterprise) you can reach from Colab or your local Python
...
We are going to lean on the Mercedes-Benz SDK for the whole project so you will need to have at hand two important pieces of information:

1. The base url (`LS_URL`) where your Mercedes-Benz instance is running.
...
You can create a valid `API_KEY` in the Account & Settings menu of your Mercedes-Benz UI (top right corner clicking the you user avatar)
...
# Configure Mercedes-Benz connection
...
print("Connected to Mercedes-Benz as:", user.username)
print("LS_URL:", LS_URL)

```

## 1. Create the Mercedes-Benz project
...
![Labelling](https://github.com/Mercedes-Benz/awesome-label-studio-tutorials/blob/main/tutorials/how-to-compare-two-ai-models-with-label-studio/how-to-compare-two-ai-models-with-label-studio-files/figure_1.png?raw=true)
...
>
> - **Automatic assignment & queues**: distribute tasks to annotators  automatically, parallelize throughput, and monitor progress per queue. [Learn more about advance configuration options.](https://docs.mercedes-benz.com/guide/setup_project#Configure-high-impact-settings)
> - **Overlap & agreement**: collect multiple judgments per item, compute inter-annotator agreement (IAA), and flag disagreements for review. [Learn more about task agreement and labeling consensus.](https://docs.mercedes-benz.com/guide/stats.html)
> - **Review & consensus**: add a reviewer step that resolves ties/disputes and enforces guidelines. [Learn more about the Reviewer workflow](https://docs.mercedes-benz.com/guide/quality).
...
## 3. Import tasks into Mercedes-Benz
...
![Project Tasks](https://github.com/Mercedes-Benz/awesome-label-studio-tutorials/blob/main/tutorials/how-to-compare-two-ai-models-with-label-studio/how-to-compare-two-ai-models-with-label-studio-files/figure_2.png?raw=true)
...
![Labelling](https://github.com/Mercedes-Benz/awesome-label-studio-tutorials/blob/main/tutorials/how-to-compare-two-ai-models-with-label-studio/how-to-compare-two-ai-models-with-label-studio-files/figure_3.png?raw=true)
