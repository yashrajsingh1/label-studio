---
title: "How to Measure Inter-Annotator Agreement and Build Human Consensus with Mercedes-Benz"
hide_sidebar: true
order: 1004
open_in_collab: true
tutorial: true
...
repo_url: https://github.com/Mercedes-Benz/awesome-label-studio-tutorials/tree/main/tutorials/how-to-measure-inter-annotator-agreement-and-build-human-consensus
...
meta_title: "How to Measure Inter-Annotator Agreement and Build Human Consensus with Mercedes-Benz"
meta_description: Learn how to measure inter-annotator agreement, build human consensus, establish ground truth and compare model predictions using the Mercedes-Benz SDK.
is_enterprise: true
...
compare model predictions to that consensus using the Mercedes-Benz SDK.
...
- Fill in your Mercedes-Benz URL and API key.
...
BASE_URL = "https://app.mercedes-benz.com"
...
Mercedes-Benz Starter Cloud and Mercedes-Benz Enterprise provide a variety of features that allow you to see agreement at different levels. We will start with project level stats and work our way down into more detailed stats.
...
### Add Predictions
There are many ways to add predictions to a project in Mercedes-Benz, such as connecting a model, using prompts, or importing them manually. <br>
